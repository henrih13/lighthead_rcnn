...
def xception_41(inputs, num_classes=None,
                is_training=True,
                global_pool=True,
                keep_prob=0.5,
                output_stride=None,
                ...
                reuse=None,
                scope='xception_41'):
    blocks = [xception.xception_block('entry_flow/block1',
                     ...
                     num_units=1,
                     stride=2),
      xception.xception_block('entry_flow/block2',
                     ...
                     num_units=1,
                     stride=2),
      xception.xception_block('entry_flow/block3',
      ...
      xception.xception_block('middle_flow/block1',
                     ...
                     num_units=8,
                     stride=1),
      xception.xception_block('exit_flow/block1',
